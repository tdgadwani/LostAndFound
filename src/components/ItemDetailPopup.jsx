...
const ItemDetailPopup = ({ onClose, item }) => {
    ...
    return (
      <>
        ...
        <div className="relative bg-gray-200 p-4 md:p-6 rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-1/2 max-h-3/4 overflow-auto mt-60 md:mt-0 lg:-mt-0 xl:mt-0">
            ...
            <div className="flex flex-col md:flex-row justify-evenly items-center">
              ...
              <div className=" flex flex-col justify-center w-full md:w-1/2 mt-4 md:mt-0 md:ml-4">
                <div className=" font-bold mb-4  text-center text-2xl ">
                  Item Details
                </div>
