...
const ItemCard = ({item}) => {
    ...
    return (
        <>
        <div
            className="h-72 w-56 bg-kaddu-123 mx-10 my-7 p-2 border-2 rounded-xl "
            onClick={() => setShowItemDetailPopup(true)}
        >
            <div className="h-52 flex flex-col justify-center bg-kaddu-500 rounded-lg p-2" >
            ...
            <div className="flex justify-between">
                <div className="flex flex-col">
                    <h1 className="font-bold text-black mt-1">{item?.itemName || "Item"} </h1>
