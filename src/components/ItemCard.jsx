...
// const Item = ({cloudinaryImageId,itemName,type,address,dateFound}) => {
  ...
  return (
    ...
    <div className='h-72 w-64 bg-slate-200 m-2 p-2 rounded-md' onClick={()=> setShowItemDetailPopup(true)}>
    ...
    {showItemDetailPopup && <ItemDetailPopup onClose={()=> setShowItemDetailPopup(false)}/> }
    </>
  )
}
