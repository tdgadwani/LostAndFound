      ...
      <div className="flex items-center space-x-4">
        ...
        >
          <li className="md:mt-0 mt-2">
            <Link
              to={ROUTES.LOSTITEMS}
              className="block px-4 py-2 md:p-0 hover:text-blue-gray-200 text-sm md:text-lg"
            >
              Lost
            </Link>
          </li>
        ...
        <div className="relative flex justify-center items-center gap-2">
          ...
          {showNotification && (
            <div
              className="bg-kaddu-800 w-[320px] h-[400px] md:w-[500px] md:h-[500px] absolute right-0 top-12"
              ref={showref}
            >
              <NotificationComp />
            </div>
