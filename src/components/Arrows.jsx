...
export const NextArrow = ({ onClick }) => {
  return (
    <div
      onClick={onClick}
      className="text-0 right-[-25px] left-auto leading-0 absolute top-1/2 block w-5 h-5 p-0 transform -translate-y-1/2 cursor-pointer text-transparent border-none outline-none bg-transparent"
    >
