...
const CreateAccount = () => {
    ...
    return (
        <>
            <div className='bg-kaddu-500 flex h-screen justify-between' style={{
                ...
                <div className='w-2/5 m-8 bg-white flex flex-col justify-evenly items-center rounded-3xl'>
                    ...
                    <div className=' flex flex-col justify-evenly items-center '>
                        ...
                        <div className='my-2'>
                            ...
                            <div>
                                <button className='bg-kaddu-500 p-3 w-full border-2 mt-2 font-bold text-xl' onClick={() => setShowVerificationOTPPage(true)}>Create Account</button>
                            </div>
                        </div>
            ...
            {showVerificationOTPPage && <OTPPopup onClose={() => setShowVerificationOTPPage(false)} />}
        </>
    )
}
